...
class Server:
    __slots__ = ('handlers', 'hostname', 'port', 'static_path', 'write_error_handler')

    def __init__(self, *, hostname='', port=8888, static_path='static', write_error=None):
        ...
        self.handlers = []
        self.write_error_handler = write_error

    def register(self, url_pattern, handler, *, delete=None, get=None, patch=None, post=None, put=None, url_name=None, **kwargs):
        ...
        if inspect.isroutine(handler):  # Return true if the object is a user-defined or built-in function or method.
            ...
            write_error_handler = self.write_error_handler
            ...
            class Handler(tornado.web.RequestHandler):
                ...
                def get_fields(self):
                    return dict(self.get_arguments())
                ...
                def write_error(self, status_code, **kwargs):
                    if write_error_handler is None or status_code != 404:
                        return super().write_error(status_code, **kwargs)
                    else:
                        return write_error_handler(self, **kwargs)
