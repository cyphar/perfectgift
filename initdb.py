...
def generate_user_row(fname, lname, username, email, passw, dob):
...
while i < len(emails):
  ...
  generate_user_row(fname_index, lname_index, username_index, email_index, password_index, str(randint(1900,2000)) + "-" + str(randint(0, 12)) + "-" + str(randint(0, 31)))
  i += 1
